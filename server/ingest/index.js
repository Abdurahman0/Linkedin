...
export const inngest = new Inngest({ id: 'linkedin-app' })
...
// Reminder when a new connection request is added
const sendNewConnectionRequestReminder = inngest.createFunction(
	...
	async ({ event, step }) => {
		...
		await step.run('send-connection-request-mail', async () => {
			...
			<br />
			<p>Thanks, <br /> Linkedin - Stay Connected</p>
			</div>`
...
// Deleting a story after 24 hours
