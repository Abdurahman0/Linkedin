...
const UserCard = ({ user }) => {
	...
	return (
		...
		>
			...
			<div className='flex items-center justify-center gap-2 mt-4 text-xs rounded-full px-3 py-1'>
			...
			<div className='flex mt-4 gap-2'>
				...
				<button
					...
					className='w-full disabled:active:scale-100 disabled:cursor-not-allowed
					disabled:from-indigo-400 disabled:to-purple-300 disabled:hover:from-indigo-400 disabled:hover:to-purple-300 py-2 rounded-md flex justify-center items-center gap-2 bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer'
				>
